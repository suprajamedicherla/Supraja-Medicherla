...
💬 **Note**: This tool is for **self-awareness only** and not a professional diagnosis.
""")
...
if st.button("🔍 Assess My Anxiety Level"):
    ...
    user_input_encoded = user_input_encoded.toarray() if hasattr(user_input_encoded, "toarray") else user_input_encoded
